...
| ----------------------------------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `theme:…/wien-light` (AppTheme id `light`)      | theme             | Wien CD light theme. Labels in Settings → Appearance come from `userSettings` i18n (DE: „Wien (hell)“, EN: „Light“). Palette: Wien Rot `#ff0000`, Abendstimmung `#49274b`, Nebelgrau Light `#f3f1ef`. |
| `theme:…/wien-dark` (AppTheme id `dark`)       | theme             | Wien CD dark theme (same palette on `#1b1b1b`). Labels: DE „Wien (dunkel)“, EN „Dark“.                                                                                         |
