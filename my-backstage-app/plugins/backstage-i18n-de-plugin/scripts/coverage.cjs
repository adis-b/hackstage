 ...
 *
 *     node plugins/backstage-i18n-de-plugin/scripts/coverage.cjs                    # report only
 *     node plugins/backstage-i18n-de-plugin/scripts/coverage.cjs --require-coverage 80
 */
'use strict';
...
// ── 2. Read every i18n-de translation message bundle ──────────────────────
//
...
for (const file of fs.readdirSync(MESSAGES_DIR)) {
  ...
  if (file === 'wienI18nDe.ts') continue; // own ref, handled separately
...
console.log('# Wien i18n-de German Translation Coverage Report\n');
